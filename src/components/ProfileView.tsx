...
export const ProfileView: React.FC<ProfileViewProps> = ({ onOpenVerification }) => {
  ...
  const [availability, setAvailability] = useState(user?.worker_profile?.availability || 'NO_DISPONIBLE');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isWorker) { payload.profession = profession; payload.hourly_rate_rd = hourlyRate; payload.bio = bio; payload.availability = availability; }
