...
import { Wallet as WalletIcon, Lock, Clock, ArrowUpRight, CheckCircle } from 'lucide-react';
...
export const WalletView: React.FC = () => {
  ...
  // El CLIENTE no tiene una billetera operativa ni retiro normal.
  // Sus depósitos/pagos por Custodia se realizan únicamente desde los flujos de contratación.
