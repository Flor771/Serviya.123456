...
function printContractWithoutPopup(card: HTMLElement) {
...
export const ContractDocumentDownload: React.FC = () => {
  useEffect(() => {
    const inject = () => {
      ...
      button.textContent = '📥 Descargar contrato PDF';
      button.style.cssText='width:100%;margin-top:14px;padding:12px 14px;border-radius:12px;border:1px solid #0b4fa3;background:#0b4fa3;color:white;font-weight:900;font-size:13px;cursor:pointer;box-shadow:0 4px 12px rgba(11,79,163,.18)';
      button.addEventListener('click',event=>{event.preventDefault();event.stopPropagation();printContractWithoutPopup(card);});
