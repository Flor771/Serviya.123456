...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
    const handleNavigate = (event: Event) => {
      ...
      else if (destination === 'dispute') { setActiveTab(isWorker ? 'mis-servicios' : 'mis-trabajos'); if (serviceId) setDisputeServiceId(serviceId); }
