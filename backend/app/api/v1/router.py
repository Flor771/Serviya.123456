...
from app.api.v1.admin_release_snapshot import router as admin_release_snapshot_router
from app.api.v1.admin_release import router as admin_release_router
from app.api.v1.admin_contracts import router as admin_contracts_router
...
from app.api.v1.admin_withdrawal_details import router as admin_withdrawal_details_router
...
from app.api.v1.admin_disputes_snapshot import router as admin_disputes_snapshot_router
...
api_router.include_router(auth_router); api_router.include_router(users_router); api_router.include_router(services_router); api_router.include_router(applications_router); api_router.include_router(contracts_router); api_router.include_router(wallet_router); api_router.include_router(negotiation_router); api_router.include_router(completion_router); api_router.include_router(warranty_router); api_router.include_router(payment_receipts_router); api_router.include_router(payments_router); api_router.include_router(client_funds_router); api_router.include_router(disputes_router); api_router.include_router(notifications_router); api_router.include_router(messages_router); api_router.include_router(reviews_router); api_router.include_router(verification_router); api_router.include_router(portfolio_support_router); api_router.include_router(announcements_router); api_router.include_router(processes_router); api_router.include_router(admin_disputes_snapshot_router); api_router.include_router(admin_disputes_router); api_router.include_router(admin_withdrawal_compat_router); api_router.include_router(admin_withdrawal_details_router); api_router.include_router(admin_router); api_router.include_router(admin_detailed_router); api_router.include_router(admin_financial_router); api_router.include_router(admin_release_snapshot_router); api_router.include_router(admin_release_router); api_router.include_router(admin_contracts_router); api_router.include_router(admin_roles_router); api_router.include_router(admin_verification_compat_router); api_router.include_router(admin_trace_router); api_router.include_router(worker_bank_account_router); api_router.include_router(work_status_router)
